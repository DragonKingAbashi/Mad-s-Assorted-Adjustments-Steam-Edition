...
namespace MadsAssortedAdjustment.Patches
{
    internal static class UnlockItemsByResearch
    {
        ...
        internal class UnlockConfiguration
        {
            ...
            public int RequirementCount() => RequiredResearchDefs.Count;
            public bool HasSingleRequirement() => RequiredResearchDefs.Count == 1;
        }
        ...
        public static void Init()
        {
                ...
                if (isStandAloneItem)
                {
                    ...
                    if (tiDef is WeaponDef wDef)
                    {
                        ...
                        if (wDef.name.Contains("SniperRifle"))
                        {
                            ...
                            DamageKeywordPair piercingDamage = new DamageKeywordPair();
            ...
            UnlockConfiguration Test = new UnlockConfiguration("Test")
            {
                UnlockableItemDefs = new List<string>()
                {
                    ...
                    "SY_Infiltrator_Venom_Helmet_BodyPartDef",
                    "SY_Infiltrator_Venom_Torso_BodyPartDef",
                    "SY_Infiltrator_Venom_Legs_BodyPartDef",
                    "AN_Mace_WeaponDef",
                    "NEU_Assault_Torso_BodyPartDef",
                    "NEU_Assault_Helmet_BodyPartDef",
                    "NEU_Assault_Legs_BodyPartDef",
                    "AN_Priest_Legs_AZ_BodyPartDef",
                    "AN_Priest_Torso_AZ_BodyPartDef",
                    "AN_Priest_Helmet_AZ_BodyPartDef",
                    "NJ_Technician_Legs_ALN_BodyPartDef",
                    "NJ_Technician_Torso_ALN_BodyPartDef",
                    "NJ_Technician_Helmet_ALN_BodyPartDef",
                    "NJ_Technician_MechArms_ALN_WeaponDef",
                    "SY_Infiltrator_Bonus_Helmet_BodyPartDef",
                    "SY_Infiltrator_Bonus_Torso_BodyPartDef",
                    "SY_Infiltrator_Bonus_Legs_BodyPartDef",
                },
            ...
            UnlockConfiguration PhoenixEliteGear = new UnlockConfiguration("PhoenixEliteGear")
            {
                UnlockableItemDefs = new List<string>()
                {
                    ...
                    "NJ_TobiasWest_Helmet_BodyPartDef",
                    "NJ_TobiasWest_Torso_BodyPartDef",
                    "NJ_TobiasWest_Legs_BodyPartDef",
                    "SY_Leader_Helmet_BodyPartDef",
                    "SY_Leader_Torso_BodyPartDef",
                    "SY_Leader_Legs_BodyPartDef",
                    "AN_Exalted_Torso_BodyPartDef",
                    "AN_Exalted_Helmet_BodyPartDef",
                    "AN_Exalted_Legs_BodyPartDef",
            ...
            UnlockConfiguration HiddenItem = new UnlockConfiguration("HiddenItem")
            {
                UnlockableItemDefs = new List<string>()
                {
            ...
            if (AssortedAdjustments.Settings.UnlockHiddenItem)
            {
                UnlockConfigurations.Add(HiddenItem);
            }
        }
        ...
        public static class Research_Initialize_Patch
        {
            ...
            public static void Postfix(Research __instance)
            {
                try
                {
                    ...
                    {
                        if (allCompletedResearchKeys.ContainsAllItems(c.RequiredResearchDefs))
                        {
            ...
            public static void Prefix(ResearchElement __instance)
            {
                try
                {
                    ...
                    foreach (UnlockConfiguration c in UnlockConfigurations)
                    {
                        ...
                        if (c.RequiredResearchDefs.Contains(currentlyCompletingResearchDef) && allCompletedResearchKeys.ContainsAllItems(c.RequiredResearchDefs))
                        {
